...
async function getWeatherData(lat, lon) {
    let api = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=5a1c1165aa58181975114022e5fd4336`;
...
function dataHandler(data) {
    ...
    minTemp.innerHTML = "Max Temp:" + temp_min;
    maxTemp.innerHTML = "Min Temp:" + temp_max;
    windSpeed.innerHTML = "windspeed"+speed;
    setIcon.style["background"] = `url(${setIconFunction(data.weather[0].icon)})`;
}
